...
export class OptionAnswersReducer {
  ...
  optionAnswersReducer(action: CustomAction) {
    const state: IOptionAnswersMaps = this._ngSurveyStore.dataStore.optionAnswers;
    ...
    switch (action.type) {
      case optionAnswers.OptionAnswersActionTypes.ADD_OPTION_ANSWERS_ACTION: {
        ...
        this._ngSurveyStore.updateOptionAnswers(state);
        break;
      }
      ...
      case optionAnswers.OptionAnswersActionTypes.RESET_OPTION_ANSWERS_STATE: {
        ...
        this._ngSurveyStore.updateOptionAnswers(ngSurveyState.optionAnswers);
        break;
      }
